...
randNum100K = randNum1 * 100000;
console.log(randNum100K);
...
if (luzernPopulation > randNum100K){
    console.log("Go Luzern!");
}
else if (luzernPopulation == randNum100K) {
...
finalPositive = finalStr.substring(0, finalStr.length - str2.length);
console.log(finalPositive);

// f. Now shout it loud and make the it upper case.
// Hint: Use toUpperCase.
finalUpper = finalPositive.toUpperCase();
console.log(finalUpper);
...
finalShout = finalUpper.replace(".", "!");
console.log(finalShout);
